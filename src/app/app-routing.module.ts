...
import { Counter5Component } from './pages/counter5/counter5.component';
...
const AppRoutes: Routes = [
  ...
  { path: 'nav', component: SidenavComponent, data: { title: 'sidenav ' } },
  { path: 'counter', component: Counter5Component, data: { title: 'counter ' } },
];
